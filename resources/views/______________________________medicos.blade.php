...
<div class="container-fluid" id="banner1">
	<img src="img/fondo_azul_responsivo.png" class="img-responsive center-block hidden-md hidden-lg cover-img">
	<img src="img/imagen_principal_doc.png" class="img-responsive center-block hidden-xs hidden-sm" id="img-banner1">
	<button class="btn-banner center-block">Aplica ahora</button>
</div><!--END DIV-->
<!--BEGIN DIV-->
...
<!--BEGIN DIV-->
<div class="container-fluid parallax-window doc-health-ad" data-parallax="scroll" data-image-src="img/download_app_bg.png">
