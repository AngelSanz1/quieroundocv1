...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('/global/css/plugins.min.csss') }}" rel="stylesheet" type="text/css" />
                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet ">
                                    ...
                                    <div class="profile-userpic">
                                        <img src="{{ asset('/storage/3/IFE_3.png') }}" class="img-responsive" alt=""> </div>
                                    <!-- END SIDEBAR USERPIC -->
                                    <!-- SIDEBAR USER TITLE -->
                            ...
                            <div class="page-quick-sidebar-item">
                                <div class="page-quick-sidebar-chat-user">
                                    ...
                                    <div class="page-quick-sidebar-chat-user-messages">
                                        ...
                                        <div class="post in">
                                            <img class="avatar" alt="" src="{{ asset('/layouts/layout/img/avatar2.jpg') }}../assets/" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="javascript:;" class="name">Ella Wong</a>
                                        ...
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{ asset('/ayouts/layout/img/avatar3.jpg') }}../assets/l" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="javascript:;" class="name">Bob Nilson</a>
                                                <span class="datetime">20:17</span>
                                        ...
                                        <div class="post out">
                                            <img class="avatar" alt="" src="{{ asset('/layouts/layout/img/avatar3.jpg') }}../assets/" />
                                            <div class="message">
                                                <span class="arrow"></span>
                                                <a href="javascript:;" class="name">Bob Nilson</a>
                                                <span class="datetime">20:17</span>
