			...
			<ul class="nav navbar-nav pull-right">
				...
				<li class="dropdown dropdown-user">
					<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
						...
						<span class="username username-hide-on-mobile">Administrador: {{ Auth::user()->name }}  </span>
								...
								<div class="col-md-3">
									<ul class="list-unstyled profile-nav">
										<li>
											...
											<img src="{{  asset( Auth::user()->url_photo) }}" class="img-responsive pic-bordered" alt="" />
								...
								<div class="col-md-9">
									<div class="row">
										<div class="col-md-8 profile-info">
											<h1 class="font-black sbold uppercase">Bienvenido!</h1>

											<h1 class="font-green sbold uppercase">Administrador: {{ Auth::user()->name }} {{ Auth::user()->last_name }} </h1>

											<p> Este es el Home del panel de administradores
											</p>
											...
											<ul class="list-inline">
												...
												<li>
													<i class="fa fa-calendar"></i>{{ Auth::user()->date_birth }} </li>
												<li>
													<i class="fa fa-briefcase"></i> {{ Auth::user()->phone }} </li>
												<li>
										...
										<div class="col-md-4">
											<div class="portlet sale-summary">
												<div class="portlet-title">
													<div class="caption font-red sbold"> Datos </div>
													<div class="tools">
												...
												<div class="portlet-body">
													<ul class="list-unstyled">
														<li>
                                                                    <span class="sale-info"> Total de Medicos
                                                                        <i class="fa fa-img-up"></i>
                                                                    </span>
															<span class="sale-num"> {{count(\App\Doctor::all())}} </span>
														</li>
														<li>
                                                                    <span class="sale-info"> Total de Pacientes
                                                                        <i class="fa fa-img-down"></i>
                                                                    </span>
															<span class="sale-num">  {{count(\DB::table('patient')->get())}}</span>
														</li>
														<li>
															<span class="sale-info"> Total de administradores</span>
															<span class="sale-num">{{count(\DB::table('administrador')->get())}} </span>
														</li>
													</ul>
												</div>
											</div>
									...
									<div class="tabbable-line tabbable-custom-profile">
										<ul class="nav nav-tabs">
											<li class="active">
												<a href="#tab_1_11" data-toggle="tab"> Actividades </a>
											</li>
											<li>
											...
											<div class="tab-pane active" id="tab_1_11">
												<div class="portlet-body">
													<table class="table table-striped table-bordered table-advance table-hover">
														...
														<tr>
															<th>
																<i class="fa fa-briefcase"></i> Nombre  </th>
															<th class="hidden-xs">
																<i class="fa fa-question"></i> Descripcion </th>
															<th>
																<i class="fa fa-bookmark"> Acciones</i>
															</th>
															<th> </th>
														</tr>
														</thead>
														...
														<tr>
															<td>
																<a href="{{route('admin.doctors.index')}}"> Aprobar Documentos </a>
															</td>
															<td class="hidden-xs"> En esta sección puedes aprobar los archivos que suben los medicos</td>

															<td>
																<a href="{{route('admin.doctors.index')}}" class="btn btn-sm grey-salsa btn-outline" href="javascript:;"> Ir </a>
															</td>
														</tr>
														<tr>
															<td>
																<a href="javascript:;"> Ver medicos </a>
															</td>
															<td class="hidden-xs">En esta sección se podrán ver todos los medicos </td>

															<td>
																<a class="btn btn-sm grey-salsa btn-outline" href="javascript:;"> Ir </a>
															</td>
														</tr>
														<tr>
															<td>
																<a href="javascript:;">Ver Pacientes</a>
															</td>
														...
														<tr>
															<td>
																<a href="javascript:;"> Ver administradores </a>
															</td>
															<td class="hidden-xs"> </td>
														...
														<tr>
															<td>
																<a href="javascript:;"> Ver consultas </a>
															</td>
															<td class="hidden-xs">  </td>
