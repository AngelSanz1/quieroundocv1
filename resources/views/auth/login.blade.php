        ...
        <div class="content">
            ...
            <form class="login-form" role="form" method="POST"  action="{{ url('/auth/login') }}" >
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn green pull-right" style="background-color:#009DDE"> Login </button>
                </div>
                <div class="login-options">
                    ...
                    <ul class="social-icons">
                        ...
                        <li>
                            <a class="googleplus" data-original-title="Goole Plus" href="{{ url('/auth/facebook') }}"> </a>
                        </li>
                        <li>
