	...
	<form class="login-form" method="post"  action="{{ url('/auth/register') }}" >
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="text" placeholder="Escribe tu nombre(s)" name="name" value="{{ old('name') }}" required/> </div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Apellido</label>
			<div class="input-icon">
				<i class="fa fa-font"></i>
				<input class="form-control placeholder-no-fix" type="text" placeholder="Escribe tu apellido" name="last_name"  value="{{ old('last_name') }}" required/> </div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<div class="input-icon">
				...
				<input class="form-control placeholder-no-fix" type="date" placeholder="Fecha" name="date_birth" value="{{ old('date_birth') }}" required/> </div>
		</div>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Telefono </label>
			<div class="input-icon">
				<i class="fa fa-location-arrow"></i>
				<input class="form-control placeholder-no-fix" type="phone" placeholder="Telefono" name="phone" required/> </div>
		</div>
		<!-- <div class="form-group">
		...
		<div class="form-group">
			...
			<select name="gender" placeholder="Selecciona tu sexo" class="select2 form-control">
